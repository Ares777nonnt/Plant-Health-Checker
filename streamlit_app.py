...
# Carica dataset TRY da GitHub
try_df = pd.read_csv("https://raw.githubusercontent.com/Ares777nonnt/Plant-Health-Checker/main/try_subset.csv", sep="\t", engine="python", on_bad_lines='skip')
